 ...
 * Spring Security calls this to load users during authentication.
 *
 * Why create this?
 * - Spring Security doesn't know about OUR User entity
 * - Spring Security doesn't know about OUR UserRepository
 * - We need to teach it how to load users from OUR database
 */
@Service
public class CustomerUserDetailsService implements UserDetailsService
{
     ...
     * 1. During login - to verify password
     * 2. In JWT filter - to load user for authentication
     *
