 ...
 * 1. Generate JWT tokens (when user logs in)
 * 2. Validate JWT tokens (on every protected request)
 * 3. Extract information from tokens (username, expiration, etc.)
 */
@Component
public class JwtUtil {
     ...
     * This should be in application.properties: jwt.secret=your-256-bit-secret-key-here
     *
     * Why 256-bit?
     * - HS256 algorithm requires at least 256 bits (32 characters)
     * - Longer = more secure
     ...
     *
     * After 24 hours, the token expires and user must login again
     * You can adjust this:
     * - 1 hour: 1000 * 60 * 60
     ...
     * How it works:
     * 1. Parse the token
     * 2. Get the "subject" claim (we store username here)
     * 3. Return it
     */
     ...
     *
     * What's a claim?
     * - A piece of information stored in the JWT
     * - Examples: username (subject), expiration, custom data
     *
     * @param claimsResolver Function that extracts specific claim
     */
    ...
    /**
     * Convert SECRET_KEY string to SecretKey object
     * jjwt library needs this format for signing/verifying
     */
